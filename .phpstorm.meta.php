...
namespace PHPSTORM_META {
    ...
    override(\config(), map([
        ...
        'auth.guards.pelanggan.driver' => 'string',
        'auth.guards.pelanggan.provider' => 'string',
        ...
        'auth.providers.pelanggan.driver' => 'string',
        'auth.providers.pelanggan.model' => 'string',
        ...
        'filesystems.links.D:\htdocs\UKK_Listrik_PascaBayar_18\public\storage' => 'string',
    ...
    registerArgumentsSet('configs',
        ...
        'app.aliases.Vite', 'app.author', 'auth.defaults.guard', 'auth.defaults.passwords', 'auth.guards.web.driver',
        'auth.guards.web.provider', 'auth.guards.admin.driver', 'auth.guards.admin.provider', 'auth.guards.pelanggan.driver', 'auth.guards.pelanggan.provider',
        'auth.providers.users.driver', 'auth.providers.users.model', 'auth.providers.admins.driver', 'auth.providers.admins.model', 'auth.providers.pelanggan.driver',
        'auth.providers.pelanggan.model', 'auth.passwords.users.provider', 'auth.passwords.users.table', 'auth.passwords.users.expire', 'auth.passwords.users.throttle',
        ...
        'filesystems.disks.s3.throw', 'filesystems.links.D:\\htdocs\\UKK_Listrik_PascaBayar_18\\public\\storage', 'ide-helper.filename', 'ide-helper.models_filename', 'ide-helper.meta_filename',
        ...
        'ide-helper.macroable_traits', 'livewire.class_namespace', 'livewire.view_path', 'livewire.layout', 'livewire.lazy_placeholder',
        ...
        'view.compiled', 'tinker.commands', 'tinker.alias', 'tinker.dont_alias', );
    ...
    registerArgumentsSet('routes',
        ...
        'livewire.preview-file', 'dashboard', 'electricBills',
        'UsageHistory', 'make-payment', 'confirm-and-pay', 'generate-report', 'listTariff',
        'customer-management', 'admin-management', 'register', 'login', 'storage.local', );
    registerArgumentsSet('views',
        'PayAndConfirm', 'adminManagement', 'components.application-logo', 'components.dependency.alert-toast', 'components.dependency.sweetalert',
        'components.form.button-submit', 'components.form.input-checkbox', 'components.form.input-dropdown', 'components.form.input-dropdown-list', 'components.form.input-text',
        'components.form.input-textarea', 'components.navbar.collapse', 'components.navbar.notification', 'components.sidebar.nav-link', 'components.sidebar.navigation',
        'components.table.datatables', 'customerManagement', 'dashboard', 'electricBills', 'generateReport',
        'layouts.app', 'layouts.guest', 'livewire.layout.navigation', 'livewire.layout.sidebar', 'livewire.navbar.bill-list',
        'livewire.navbar.bills-notify', 'livewire.notify.alert', 'livewire.pages.admin.content', 'livewire.pages.auth.login', 'livewire.pages.auth.register',
        'livewire.pages.customer.content', 'livewire.pages.dashboard.datatableadminslistshown', 'livewire.pages.dashboard.datatablelatestpaymentsshown', 'livewire.pages.dashboard.datatablepaymentbyuserslistshown', 'livewire.pages.dashboard.datatableusersshown',
        'livewire.pages.dashboard.info-box-user', 'livewire.pages.electricbill.content', 'livewire.pages.generetereport.content', 'livewire.pages.makepayment.billspages', 'livewire.pages.makepayment.paymentspages',
        'livewire.pages.tariffprice.content', 'livewire.pages.usagehistory.content', 'livewire.pages.usagehistory.printdataonerow', 'livewire.welcome.navigation', 'makePayment',
        'placeholder.dashboard.dataTableUserShown', 'placeholder.dashboard.info-box', 'profile', 'tariffPrice', 'usageHistory',
        'volt-livewire::layout.navigation', 'volt-livewire::layout.sidebar', 'volt-livewire::navbar.bill-list', 'volt-livewire::navbar.bills-notify', 'volt-livewire::notify.alert',
        'volt-livewire::pages.admin.content', 'volt-livewire::pages.auth.login', 'volt-livewire::pages.auth.register', 'volt-livewire::pages.customer.content', 'volt-livewire::pages.dashboard.datatableadminslistshown',
        'volt-livewire::pages.dashboard.datatablelatestpaymentsshown', 'volt-livewire::pages.dashboard.datatablepaymentbyuserslistshown', 'volt-livewire::pages.dashboard.datatableusersshown', 'volt-livewire::pages.dashboard.info-box-user', 'volt-livewire::pages.electricbill.content',
        'volt-livewire::pages.generetereport.content', 'volt-livewire::pages.makepayment.billspages', 'volt-livewire::pages.makepayment.paymentspages', 'volt-livewire::pages.tariffprice.content', 'volt-livewire::pages.usagehistory.content',
        'volt-livewire::pages.usagehistory.printdataonerow', 'volt-livewire::welcome.navigation', 'laravel-exceptions-renderer::components.card', 'laravel-exceptions-renderer::components.context', 'laravel-exceptions-renderer::components.editor',
    ...
    registerArgumentsSet('env',
        'APP_NAME', 'APP_AUTHOR', 'APP_ENV', 'APP_KEY', 'APP_DEBUG',
